...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        seeder.add_entity(SSD, options['number'], {
            ...
            'model': lambda x: f"{seeder.faker.random_element(models)} {seeder.faker.random_element(['Pro', 'Plus', 'Ultra', 'X', 'Lite'])}"[:50],
            ...
            'price': lambda x: Decimal(seeder.faker.random_int(2000, 30000) + Decimal(seeder.faker.random_int(0, 99)) / 100),
